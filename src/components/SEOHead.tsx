...
export const SEOHead = ({
  ...
  description = `Angeli Gardens - Your trusted landscaping experts. Checkatrade approved garden maintenance, patios, decking, fencing across London, Surrey & Berkshire. Rated ${CHECKATRADE_CONFIG.rating}/${CHECKATRADE_CONFIG.maxRating}. Free quotes.`,
